...
import com.rtv.models.Driver;
import com.rtv.providers.AuthProvider;
import com.rtv.providers.DriverProvider;
import com.rtv.providers.ImagesProvider;
...
public class UpdateProfileDriverActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode== GALLERY_REQUEST && resultCode == RESULT_OK) {
            try {
                mImageFile = com.transporteapp.utils.FileUtil.from(this, data.getData());
